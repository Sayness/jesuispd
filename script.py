...
async def on_message(message) :
	...
	if msg.startswith(".") :
		...
		if cmd == "HELP" :
			...
			if message.channel.id == "440260967524204554" :
			...
			# try :
				...
				await mesage.send_message(message.channel, "Ce n'est pas le bon channel !")
			# except Exception :
			# 	ftp_co.quit()
			# 	print("Le serveur FTP a été quitté suite à une erreur")

client.run("NDUxNDQ0MDk2NTE5NzY2MDE2.DfB3nA.gcEilKc_yRPqlzOqJyK6xB1e1wo")